import { damagedTable, damagedTabs } from '../../data/tables/damagedTable';
...
import { damagedQuery } from '../../utils/dashboard/returnFilterHelpers';
...
import { returnsDamagedFilter } from '../../data/schemas/returnsFilter';
...
const DashboardDamagedPageV2 = () => {
  const { filters, updateFilters, tempFilters, updateTempFilters, resetFilters, applyFilters } =
    useReturnsFilter(returnsDamagedFilter);

  const queryString = damagedQuery(filters);
...
export default DashboardDamagedPageV2;
