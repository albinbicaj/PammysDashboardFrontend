    ...
    <div className="border bg-white p-5 shadow-sm">
      ...
      >
        <Tab
          ...
          disabled={subAddActiveTab !== 0 && logs.length > 0}
        />
        <Tab
          className="mr-10 w-max text-sm font-medium leading-5 focus:outline-none"
          ...
          value={1}
          sx={{ textTransform: 'none' }}
          disabled={subAddActiveTab !== 1 && logs.length > 0}
        />
      </Tabs>
      <Box hidden={subAddActiveTab !== 0}>
