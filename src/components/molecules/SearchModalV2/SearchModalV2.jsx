      ...
      const res = await axios
        ...
        .then((response) => {
          ...
          if (data.status_code === 200) {
            navigate(`/dashboard/shopify/order/` + encodeURIComponent(searchValue));
            setShowModal(false);
              ...
              <div className="search-icon-wrapper cursor-pointer px-4 py-2">
                {loading === true ? (
                  <div className="animate-spin">
                    ...
                    <div class="loader h-5 w-5 rounded-full border-2 border-t-8 border-gray-200 ease-linear"></div>
                  </div>
                ) : (
                  <SearchIcon />
                )}
            ...
            <div className="max-h-[600px] min-h-[600px] overflow-auto ">
              {tab === 0 ? (
                      ...
                      <div className="flex flex-col gap-1">
                        {orders.map((order, index) => (
                          <Link
                            ...
                            key={index}
                            className="flex flex-col rounded-md bg-gray-50 px-4 py-2 hover:bg-secondary"
                ...
                <div>
                  ...
                  <div className="p-12 text-center">
                    Type se order number starting with # and press Enter
                  </div>
                </div>
              )}
            </div>
